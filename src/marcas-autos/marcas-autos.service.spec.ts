...
describe('MarcasAutosService con SQLite en memoria', () => {
  ...
  beforeAll(async () => {
    ...
    /**
     * Instanciamos manualmente el servicio usando el repositorio
     * de MarcaAutoSqlite, casteado a Repository<MarcaAuto>.
     * El servicio solo usa métodos del repositorio (find, etc.),
     * así que este cast es seguro en el contexto del test.
     */
